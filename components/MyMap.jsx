...
export default function MyMap({ citiesGeoJson, allWeatherData, mapbox_access_token, className }) {
  ...
  return (
    <div>
      <div ref={mapContainer} className="h-full min-h-[450px] rounded-lg ">
        <img src="/images/north-toggle.png" alt="North sign" style={{ zIndex: 1000, width: '50px', height: '50px' }} className="h-full absolute left-0 top-0 transform translate-x-8 translate-y-8 hover:opacity-75 cursor-pointer" onClick={() => flyToDefault()} />
      </div>
